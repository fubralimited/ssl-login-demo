...
<p><strong>Alternative method</strong> : click 'History' menu (press ALT key to display menu if it's not there) &rarr; 'Clear Recent History' &rarr; tick only 'Active Logins' and click 'Clear Now' button. Then <a href="javascript: window.opener.location.reload(false); window.close();">close this page and reload the previous page</a>.</p>
